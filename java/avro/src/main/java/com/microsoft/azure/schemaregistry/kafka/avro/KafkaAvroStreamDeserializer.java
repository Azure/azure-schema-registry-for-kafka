 ...
 *
 * @see KafkaAvroStreamSerializer See serializer class for upstream serializer implementation
 */
public class KafkaAvroStreamDeserializer<T extends IndexedRecord> implements Deserializer<T> {
     ...
     */
    public KafkaAvroStreamDeserializer() {
        super();
    }
