 ...
 *
 * @see KafkaAvroStreamDeserializer See deserializer class for downstream deserializer implementation
 */
public class KafkaAvroStreamSerializer<T> implements Serializer<T> {
    private SchemaRegistryApacheAvroSerializer serializer;

    /**
     * Empty constructor for Kafka producer
     */
    public KafkaAvroStreamSerializer() {
        super();
    }
